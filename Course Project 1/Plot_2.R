data <- read.csv("C:/Users/Anoushka/Documents/household_power_consumption.txt", header=TRUE, sep=';', 
...
plot(filtered_data$Global_active_power ~ filtered_data$Datetime, type="l", 
